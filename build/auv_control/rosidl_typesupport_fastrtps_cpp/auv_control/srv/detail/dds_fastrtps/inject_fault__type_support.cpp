...
#include "auv_control/srv/detail/inject_fault__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auv_control::srv::InjectFault_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auv_control::srv::InjectFault_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv_control::srv::InjectFault_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_auv_control
const rosidl_message_type_support_t *
get_message_type_support_handle<auv_control::srv::InjectFault_Request>()
{
  return &auv_control::srv::typesupport_fastrtps_cpp::_InjectFault_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = auv_control::srv::InjectFault_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auv_control::srv::InjectFault_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<auv_control::srv::InjectFault_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &auv_control::srv::typesupport_fastrtps_cpp::_InjectFault_Response__handle;
}
...
static rosidl_service_type_support_t _InjectFault__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &auv_control::srv::typesupport_fastrtps_cpp::_InjectFault__handle;
}
