...
static const _InjectFault_Request_type_support_symbol_names_t _InjectFault_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auv_control, srv, InjectFault_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auv_control, srv, InjectFault_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, auv_control, srv, InjectFault_Request)() {
  return &::auv_control::srv::rosidl_typesupport_c::InjectFault_Request_message_type_support_handle;
}
...
static const _InjectFault_Response_type_support_symbol_names_t _InjectFault_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auv_control, srv, InjectFault_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auv_control, srv, InjectFault_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, auv_control, srv, InjectFault_Response)() {
  return &::auv_control::srv::rosidl_typesupport_c::InjectFault_Response_message_type_support_handle;
}
...
static const _InjectFault_type_support_symbol_names_t _InjectFault_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auv_control, srv, InjectFault)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auv_control, srv, InjectFault)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, auv_control, srv, InjectFault)() {
  return &::auv_control::srv::rosidl_typesupport_c::InjectFault_service_type_support_handle;
}
